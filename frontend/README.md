...
A [re-frame](https://github.com/day8/re-frame) frontend to work with the vending machine API.
...
* [`src/software/rooijakkers/full_stack/`](src/software/rooijakkers/full_stack/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/software/rooijakkers/full_stack/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `software.rooijakkers.full-stack` project root directory
