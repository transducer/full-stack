...
The `home-routes` handler in the `software.rooijakkers.full-stack.routes.home` namespace
...
The `home-page` function will in turn call the `software.rooijakkers.full-stack.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `software.rooijakkers.full-stack.handler` namespace:
...
Request middleware functions are located under the `software.rooijakkers.full-stack.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `software.rooijakkers.full-stack.dev-middleware` namespace found in
